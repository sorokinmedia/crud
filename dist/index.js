...
var filterDropdown = (function (name, type, options) {
  return function (_ref) {
    ...
    }), React__default.createElement("br", null)) : type === 'select' ? React__default.createElement(antd.Select, {
      value: selectedKeys,
      placeholder: "\u0412\u044B\u0431\u0440\u0430\u0442\u044C",
      onChange: function onChange(e) {
        setSelectedKeys(e);
...
var StyledComponentsError = function (_Error) {
  ...
  function StyledComponentsError(code) {
    ...
    if (true) {
      ...
      var _this = possibleConstructorReturn(this, _Error.call(this, format$1.apply(undefined, [ERRORS[code]].concat(interpolations)).trim()));
    }
...
function isStaticRules(rules, attrs) {
  for (var i = 0; i < rules.length; i += 1) {
    ...
    if (Array.isArray(rule) && !isStaticRules(rule, attrs)) {
      return false;
    } else if (isFunction$2(rule) && !isStyledComponent(rule)) {
  ...
  if (attrs.some(function (x) {
    return isFunction$2(x) || hasFunctionObjectKey(x);
  })) return false;
...
var StyledComponent = function (_Component) {
  ...
  StyledComponent.prototype.buildExecutionContext = function buildExecutionContext(theme, props, attrs) {
    ...
    attrs.forEach(function (attrDef) {
      ...
      if (isFunction$2(resolvedAttrDef)) {
        // $FlowFixMe
      ...
      for (key in resolvedAttrDef) {
        ...
        if (!attrDefWasFn) {
          if (isFunction$2(attr) && !isDerivedReactComponent(attr) && !isStyledComponent(attr)) {
...
var DateCell = function DateCell(data) {
  return React__default.createElement("p", null, hooks(data).format('DD.MM.YYYY'));
};
...
var ArrObjectCell = function ArrObjectCell(obj) {
  ...
  return obj.map(function (_ref) {
    ...
    return React__default.createElement(React.Fragment, null, React__default.createElement("p", null, created_at ? hooks.unix(created_at).format('DD.MM.YYYY') : '', " ", updated_at ? hooks.unix(updated_at).format('DD.MM.YYYY') : '', " ", restAttributes), React__default.createElement("br", null));
  });
};
...
var Switch = function (_React$Component) {
  _inherits$10(Switch, _React$Component);

  function Switch() {
    _classCallCheck$10(this, Switch);
...
var dataRenderer = (function (row, column, modelName, iconTheme) {
  ...
  switch (column.type) {
    ...
    case 'link':
      ...
      if (link.url && link.name) return React__default.createElement(Link, {
        to: link.url
      }, link.name);
      var actionView = row.actions.find(function (e) {
        return e.id === 'view';
      });
      return actionView && actionView.url ? React__default.createElement(Link, {
        to: actionView.url
...
/*#__PURE__*/
function (_Component) {
  _inherits$11(CrudView, _Component);
  ...
  function CrudView() {
    ...
    _classCallCheck$11(this, CrudView);
    ...
    _defineProperty$1(_assertThisInitialized$2(_this), "handleTableChange", function (pagination, filters, sorter) {
      ...
      _this.props.setCrudParams(_objectSpread({}, _this.props.crudParams[_this.props.modelName], {
        page: pagination.current,
        order_by: sorter.columnKey,
        order: sorter.order,
        filters: filters
...
var eventPreventDefault = function eventPreventDefault(event) {
  if (isObject$3(event) && isFunction$4(event.preventDefault)) {
    event.preventDefault();
  }
};

var eventDataTransferGetData = function eventDataTransferGetData(event, key) {
  if (isObject$3(event) && isObject$3(event.dataTransfer) && isFunction$4(event.dataTransfer.getData)) {
    return event.dataTransfer.getData(key);
  }
};

var eventDataTransferSetData = function eventDataTransferSetData(event, key, value) {
  if (isObject$3(event) && isObject$3(event.dataTransfer) && isFunction$4(event.dataTransfer.setData)) {
...
var isReduxFormAction = function isReduxFormAction(action) {
  return action && action.type && action.type.length > prefix$1.length && action.type.substring(0, prefix$1.length) === prefix$1;
};
...
function (_Component) {
  ...
  function DraftEditor(props) {
    ...
    _defineProperty$9(_assertThisInitialized$3(_this), "onEditorStateChange", function (editorState) {
      ...
      _this.props.input.onChange(draftjsToHtml(draftJs.convertToRaw(editorState.getCurrentContent())));
    });
  ...
  _createClass$17(CrudFull, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", null, !createDisabled ? React__default.createElement(Btn, {
        ...
        style: _objectSpread$1({}, btnStyle, {
          marginBottom: '20px'
        })
