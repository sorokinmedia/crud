...
var wrapAsElement = function wrapAsElement(css, names) {
  return function () {
    ...
    return React__default.createElement('style', _extends$4({}, props, { dangerouslySetInnerHTML: { __html: css() } }));
  };
};
...
var StyleSheet = function () {
  ...
  StyleSheet.prototype.clone = function clone() {
    ...
    /* clone other maps */
    sheet.rehydratedNames = _extends$4({}, this.rehydratedNames);
    sheet.deferred = _extends$4({}, this.deferred);
...
function flatten(chunk, executionContext, styleSheet) {
  ...
  /* Handle objects */
  return isPlainObject$1(chunk) ? objToCss(chunk) : chunk.toString();
}
...
function constructWithOptions(componentConstructor, tag) {
  ...
  templateFunction.withConfig = function (config) {
    return constructWithOptions(componentConstructor, tag, _extends$4({}, options, config));
  };
  templateFunction.attrs = function (attrs) {
    return constructWithOptions(componentConstructor, tag, _extends$4({}, options, {
      attrs: _extends$4({}, options.attrs || EMPTY_OBJECT, attrs)
    }));
  };
...
var StyledComponent = function (_Component) {
  ...
  StyledComponent.prototype.renderInner = function renderInner(theme) {
    ...
    var propsForElement = _extends$4({}, this.attrs);

    var key = void 0;
    // eslint-disable-next-line guard-for-in
    for (key in this.props) {

      if (key === 'forwardedClass' || key === 'as') continue;else if (key === 'forwardedRef') propsForElement.ref = this.props[key];else if (!isTargetTag || index$2(key)) {
        // Don't pass through non HTML tags through to HTML elements
        propsForElement[key] = key === 'style' && key in this.attrs ? _extends$4({}, this.attrs[key], this.props[key]) : this.props[key];
      }
    }
  ...
  StyledComponent.prototype.buildExecutionContext = function buildExecutionContext(theme, props, attrs) {
    var context = _extends$4({}, props, { theme: theme });
    ...
    return _extends$4({}, context, this.attrs);
  };
...
function createStyledComponent(target, options, rules) {
  ...
  var finalAttrs =
  // $FlowFixMe
  isTargetStyledComp && target.attrs ? _extends$4({}, target.attrs, attrs) : attrs;
  ...
  var WrappedStyledComponent = React__default.forwardRef(function (props, ref) {
    return React__default.createElement(ParentComponent, _extends$4({}, props, { forwardedClass: WrappedStyledComponent, forwardedRef: ref }));
  });
  ...
  WrappedStyledComponent.withComponent = function withComponent(tag) {
    ...
    var newOptions = _extends$4({}, optionsToCopy, {
      attrs: finalAttrs,
...
var BrowserRouter = function (_React$Component) {
  ...
  function BrowserRouter() {
    ...
    _classCallCheck$4(this, BrowserRouter);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn$3(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = createBrowserHistory(_this.props), _temp), _possibleConstructorReturn$3(_this, _ret);
  }
...
var HashRouter = function (_React$Component) {
  ...
  function HashRouter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$4(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = createHashHistory(_this.props), _temp), _possibleConstructorReturn$4(_this, _ret);
  }
...
var Link = function (_React$Component) {
  ...
  Link.prototype.render = function render() {
    ...
    return React__default.createElement("a", _extends$11({}, props, { onClick: this.handleClick, href: href, ref: innerRef }));
  };
...
var MemoryRouter = function (_React$Component) {
  ...
  function MemoryRouter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$6(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = createMemoryHistory(_this.props), _temp), _possibleConstructorReturn$6(_this, _ret);
  }
...
var NavLink = function NavLink(_ref) {
  var to = _ref.to,
      ...
      rest = _objectWithoutProperties$4(_ref, ["to", "exact", "strict", "location", "activeClassName", "className", "activeStyle", "style", "isActive", "aria-current"]);
  ...
  return React__default.createElement(Route, {
    ...
    children: function children(_ref2) {
      ...
      return React__default.createElement(Link, _extends$13({
        to: to,
...
var StaticRouter = function (_React$Component) {
  ...
  StaticRouter.prototype.render = function render() {
    ...
    return React__default.createElement(Router, _extends$15({}, props, { history: history }));
  };
...
var CrudView = function (_Component) {
	...
	createClass$1(CrudView, [{
		...
		value: function componentDidMount() {
			...
			this.props.fetchCrudModels({ modelName: modelName, url: url });
		}
	}, {
		key: 'render',
		value: function render() {
			...
			var columns = items.data.columns.map(function (col) {
				return {
					...
					filterIcon: col.filter.can ? function (filtered) {
						return React__default.createElement(antd.Icon, { type: 'filter', style: { color: filtered ? '#108ee9' : '#aaa' }, theme: 'outlined' });
					} : null,
...
}, { fetchCrudModels: fetchCrudModels, fetchCrudChildren: fetchCrudChildren })(CrudView);
...
var ExtendableError = function (_extendableBuiltin2) {
  ...
  function ExtendableError() {
    ...
    _classCallCheck$15(this, ExtendableError);
...
var SubmissionError = function (_ExtendableError) {
  ...
  function SubmissionError(errors) {
    _classCallCheck$16(this, SubmissionError);
...
var createFieldProps = function createFieldProps(_ref2, name, _ref) {
  ...
  var asyncError = _ref.asyncError,
      ...
      _value = _ref._value,
      warn = _ref.warn,
      custom = _objectWithoutProperties$8(_ref, ['asyncError', 'asyncValidating', 'onBlur', 'onChange', 'onDrop', 'onDragStart', 'dirty', 'dispatch', 'onFocus', 'form', 'format', 'initial', 'parse', 'pristine', 'props', 'state', 'submitError', 'submitFailed', 'submitting', 'syncError', 'syncWarning', 'validate', 'value', '_value', 'warn']);
...
var setInWithPath = function setInWithPath(state, value, path, pathIndex) {
  ...
  return _extends$20({}, state, _defineProperty({}, first, next));
};
...
function deleteInWithPath(state, first) {
  ...
  if (rest.length) {
    ...
    if (first in state) {
      ...
      return state[first] === _result ? state : _extends$21({}, state, _defineProperty$1({}, first, _result));
    }
    return state;
  }
  if (Array.isArray(state)) {
...
var createConnectedField = function createConnectedField(structure$$1) {
  ...
  var ConnectedField = function (_Component) {
    ...
    function ConnectedField() {
      ...
      _classCallCheck$17(this, ConnectedField);
    ...
    _createClass$2(ConnectedField, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            rest = _objectWithoutProperties$9(_props, ['component', 'withRef', 'name', '_reduxForm', 'normalize', 'onBlur', 'onChange', 'onFocus', 'onDragStart', 'onDrop', 'immutableProps']);
        ...
        var _createFieldProps = createFieldProps(structure$$1, name, _extends$22({}, rest, {
          ...
          onFocus: this.handleFocus
            ...
            props = _objectWithoutProperties$9(_createFieldProps, ['custom']);
...
var createConnectedFields = function createConnectedFields(structure$$1) {
  ...
  var ConnectedFields = function (_React$Component) {
    ...
    function ConnectedFields(props) {
      _classCallCheck$19(this, ConnectedFields);
...
var createFields = function createFields(structure$$1) {
  ...
  var Fields = function (_Component) {
    ...
    function Fields(props, context) {
      _classCallCheck$20(this, Fields);
...
var createFieldArrayProps = function createFieldArrayProps(_ref2, name, form, sectionPrefix, getValue, _ref) {
  ...
  var arrayInsert = _ref.arrayInsert,
      ...
      value = _ref.value,
      props = _ref.props,
      rest = _objectWithoutProperties$11(_ref, ['arrayInsert', 'arrayMove', 'arrayPop', 'arrayPush', 'arrayRemove', 'arrayRemoveAll', 'arrayShift', 'arraySplice', 'arraySwap', 'arrayUnshift', 'asyncError', 'dirty', 'length', 'pristine', 'submitError', 'state', 'submitFailed', 'submitting', 'syncError', 'syncWarning', 'value', 'props']);
...
var createConnectedFieldArray = function createConnectedFieldArray(structure$$1) {
  ...
  var ConnectedFieldArray = function (_React$Component) {
    ...
    function ConnectedFieldArray() {
      ...
      _classCallCheck$21(this, ConnectedFieldArray);
    ...
    _createClass$6(ConnectedFieldArray, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            rest = _objectWithoutProperties$12(_props, ['component', 'withRef', 'name', '_reduxForm', 'validate', 'warn', 'rerenderOnEveryChange']);
...
var createFieldArray = function createFieldArray(structure) {
  ...
  var FieldArray = function (_Component) {
    ...
    function FieldArray(props, context) {
      _classCallCheck$22(this, FieldArray);
          ...
          value: function setComponent() {
            ...
            this.Component = connect(formValuesSelector, function () {
              ...
              var sectionPrefix = _ref3.sectionPrefix,
                  otherProps = _objectWithoutProperties$13(_ref3, ['sectionPrefix']);
...
var arrayInsert$1 = actions$3.arrayInsert,
    ...
    formActions = _objectWithoutProperties$14(actions$3, ['arrayInsert', 'arrayMove', 'arrayPop', 'arrayPush', 'arrayRemove', 'arrayRemoveAll', 'arrayShift', 'arraySplice', 'arraySwap', 'arrayUnshift', 'blur', 'change', 'focus']);
        ...
        _createClass$9(Form, [{
            ...
            if (validate || fieldLevelValidate) {
              ...
              if (shouldError(validateParams)) {
                ...
                var _merge2 = merge(validate ? validate(propsToValidate.values, propsToValidate) || {} : {}, fieldLevelValidate ? fieldLevelValidate(propsToValidate.values, propsToValidate) || {} : {}),
                    ...
                    nextSyncErrors = _objectWithoutProperties$14(_merge2, ['_error']);
            ...
            if (warn || fieldLevelWarn) {
              ...
              if (shouldWarn(validateParams)) {
                ...
                var _merge3 = merge(warn ? warn(propsToWarn.values, propsToWarn) : {}, fieldLevelWarn ? fieldLevelWarn(propsToWarn.values, propsToWarn) : {}),
                    ...
                    nextSyncWarnings = _objectWithoutProperties$14(_merge3, ['_warning']);
          ...
          value: function render() {
            ...
            var _props9 = this.props,
                ...
                rest = _objectWithoutProperties$14(_props9, ['anyTouched', 'array', 'arrayInsert', 'arrayMove', 'arrayPop', 'arrayPush', 'arrayRemove', 'arrayRemoveAll', 'arrayShift', 'arraySplice', 'arraySwap', 'arrayUnshift', 'asyncErrors', 'asyncValidate', 'asyncValidating', 'blur', 'change', 'clearSubmit', 'destroy', 'destroyOnUnmount', 'forceUnregisterOnUnmount', 'dirty', 'dispatch', 'enableReinitialize', 'error', 'focus', 'form', 'getFormState', 'immutableProps', 'initialize', 'initialized', 'initialValues', 'invalid', 'keepDirtyOnReinitialize', 'keepValues', 'updateUnregisteredFields', 'pristine', 'propNamespace', 'registeredFields', 'registerField', 'reset', 'resetSection', 'setSubmitFailed', 'setSubmitSucceeded', 'shouldAsyncValidate', 'shouldValidate', 'shouldError', 'shouldWarn', 'startAsyncValidation', 'startSubmit', 'stopAsyncValidation', 'stopSubmit', 'submitting', 'submitFailed', 'submitSucceeded', 'touch', 'touchOnBlur', 'touchOnChange', 'persistentSubmitErrors', 'syncErrors', 'syncWarnings', 'unregisterField', 'untouch', 'updateSyncErrors', 'updateSyncWarnings', 'valid', 'validExceptSubmit', 'values', 'warning']);
            ...
            var propsToPass = _extends$30({}, propNamespace ? _defineProperty$4({}, propNamespace, reduxFormProps) : reduxFormProps, rest);
...
propsToPass.ref = this.saveRef;
      ...
      var ReduxForm = function (_Component2) {
        ...
        function ReduxForm() {
          _classCallCheck$24(this, ReduxForm);
        ...
        _createClass$9(ReduxForm, [{
          ...
          value: function render() {
            ...
            var _props10 = this.props,
                ...
                rest = _objectWithoutProperties$14(_props10, ['initialValues']);
...
var _extends$32 = createCommonjsModule(function (module, exports) {
...
var _extends3 = _interopRequireDefault(_extends$32);



var _ru_RU2 = _interopRequireDefault(ru_RU);



var _ru_RU4 = _interopRequireDefault(ru_RU$2);
	...
	return React__default.createElement(
		...
		function () {
			switch (type) {
				...
				case 'textarea':
					return React__default.createElement(antd.Input.TextArea, _extends$5({}, input, {
						placeholder: placeholder,
						type: type,
				...
				case 'search':
					return React__default.createElement(Search, _extends$5({
				...
				default:
					return React__default.createElement(antd.Input, _extends$5({
						onPressEnter: onPressEnter
					}, input, {
						value: input.value || defaultValue,
						placeholder: placeholder,
...
var crudFilterValuesReducer = function crudFilterValuesReducer() {
	...
	switch (type) {
		case actions.FETCH_CRUD_FILTER_VALUES + SUCCESS$1:
			return _extends$5({}, state, defineProperty$2({
				loading: false
			}, payload.modelName, _extends$5({}, state[payload.modelName], defineProperty$2({}, payload.filter, response.data))));
		case actions.FETCH_CRUD_FILTER_VALUES + ERROR:
			return _extends$5({}, state, { loading: false, error: error
			});
		case actions.FETCH_CRUD_FILTER_VALUES + START:
			return _extends$5({}, state, { loading: true });
		default:
			return state;
	}
};
...
var crudActionsFuncReducer = function crudActionsFuncReducer() {
	...
	switch (type) {
		case actions.SET_CRUD_ACTIONS_FUNC:
			return _extends$5({}, state, defineProperty$2({}, payload.modelName, payload.func));
		default:
			return state;
	}
};
...
var crudParamsReducer = function crudParamsReducer() {
	...
	switch (type) {
		case actions.SET_CRUD_PARAMS:
			return _extends$5({}, state, defineProperty$2({}, payload.modelName, payload));
		default:
			return state;
	}
};
...
function hasOwn$1(object, property) {
  return is$2.notUndef(object) && hasOwnProperty$15.call(object, property);
}
...
var is$2 = {
  ...
  object: function object(obj) {
    return obj && !is$2.array(obj) && (typeof obj === 'undefined' ? 'undefined' : _typeof$8(obj)) === 'object';
  },
  ...
  pattern: function pattern(pat) {
    return pat && (is$2.string(pat) || (typeof pat === 'undefined' ? 'undefined' : _typeof$8(pat)) === 'symbol' || is$2.func(pat) || is$2.array(pat));
  },
  ...
  stringableFunc: function stringableFunc(f) {
    return is$2.func(f) && hasOwn$1(f, 'toString');
  }
};
...
function getFiltersValues(filters, columns) {
	...
	var res = Object.keys(filters).reduce(function (acc, key) {
		return _extends$5({}, acc, defineProperty$2({}, key, isDateColumn(columns, key) ? hooks(filters[key]).unix() : filters[key].constructor !== Array ? filters[key] : null));
	}, {});
		...
		while (1) {
			switch (_context.prev = _context.next) {
				...
				case 12:
					...
					params = payload ? dist_6(_extends$5({}, filters, {
