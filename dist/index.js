...
var actions = {
	...
	deleteModel: function deleteModel(id, url, modelName) {
		return {
			...
			payload: {
				id: id, url: url, modelName: modelName
			}
		};
	},
	...
	createModel: function createModel(form, url, modelName) {
		return {
			...
			payload: {
				form: form, url: url, modelName: modelName
			}
		};
	},
	...
	changeModel: function changeModel(form, action, modelName) {
		return {
			...
			payload: {
				form: form, action: action, modelName: modelName
			}
		};
	},
	...
	setModelModalForm: function setModelModalForm(modalType, initialValues, action) {
		return {
			...
			payload: {
				modalType: modalType, initialValues: initialValues, action: action
			}
		};
	},
	...
	fetchCrudFilterValues: function fetchCrudFilterValues(modelName, filter, query) {
		return {
			...
			payload: {
				query: query, filter: filter, modelName: modelName
			}
		};
	}
};
...
var actions_1 = actions$1.CALL_HISTORY_METHOD;
var actions_2 = actions$1.push;
var actions_3 = actions$1.replace;
var actions_4 = actions$1.go;
var actions_5 = actions$1.goBack;
var actions_6 = actions$1.goForward;
var actions_7 = actions$1.routerActions;
  ...
  return function () {
    return function (next) {
      return function (action) {
        if (action.type !== actions$1.CALL_HISTORY_METHOD) {
          return next(action);
        }
...
Object.defineProperty(exports, 'CALL_HISTORY_METHOD', {
  enumerable: true,
  get: function get() {
    return actions$1.CALL_HISTORY_METHOD;
  }
});
Object.defineProperty(exports, 'push', {
  enumerable: true,
  get: function get() {
    return actions$1.push;
  }
});
Object.defineProperty(exports, 'replace', {
  enumerable: true,
  get: function get() {
    return actions$1.replace;
  }
});
...
Object.defineProperty(exports, 'goBack', {
  enumerable: true,
  get: function get() {
    return actions$1.goBack;
  }
});
Object.defineProperty(exports, 'goForward', {
  enumerable: true,
  get: function get() {
    return actions$1.goForward;
  }
});
Object.defineProperty(exports, 'routerActions', {
  enumerable: true,
  get: function get() {
    return actions$1.routerActions;
  }
});
...
function r(a){for(var b=arguments.length-1,c="https://reactjs.org/docs/error-decoder.html?invariant="+a,d=0;d<b;d++)c+="&args[]="+encodeURIComponent(arguments[d+1]);ea(!1,"Minified React error #"+a+"; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ",c);}React__default?void 0:r("227");function fa(a,b,c,d,e,f,g,h,k){var l=Array.prototype.slice.call(arguments,3);try{b.apply(c,l);}catch(m){this.onError(m);}}
...
function Pc(a){switch(typeof a){case "boolean":case "number":case "object":case "string":case "undefined":return a;default:return""}}function Qc(a,b){var c=b.checked;return objectAssign({},b,{defaultChecked:void 0,defaultValue:void 0,value:void 0,checked:null!=c?c:a._wrapperState.initialChecked})}
...
case "keydown":case "keyup":return Je(c,d)}return null}};Ga.injectEventPluginOrder("ResponderEventPlugin SimpleEventPlugin EnterLeaveEventPlugin ChangeEventPlugin SelectEventPlugin BeforeInputEventPlugin".split(" "));wa=Qa;xa=Oa;ya=Pa;Ga.injectEventPluginsByName({SimpleEventPlugin:Zd,EnterLeaveEventPlugin:Cd,ChangeEventPlugin:qd,SelectEventPlugin:Ke,BeforeInputEventPlugin:Mb});function Le(a){var b="";React__default.Children.forEach(a,function(a){null!=a&&(b+=a);});return b}
function Me(a,b){a=objectAssign({children:void 0},b);if(b=Le(b.children))a.children=b;return a}function Ne(a,b,c,d){a=a.options;if(b){b={};for(var e=0;e<c.length;e++)b["$"+c[e]]=!0;for(c=0;c<a.length;c++)e=b.hasOwnProperty("$"+a[c].value),a[c].selected!==e&&(a[c].selected=e),e&&d&&(a[c].defaultSelected=!0);}else{c=""+Pc(c);b=null;for(e=0;e<a.length;e++){if(a[e].value===c){a[e].selected=!0;d&&(a[e].defaultSelected=!0);return}null!==b||a[e].disabled||(b=a[e]);}null!==b&&(b.selected=!0);}}
function Oe(a,b){null!=b.dangerouslySetInnerHTML?r("91"):void 0;return objectAssign({},b,{value:void 0,defaultValue:void 0,children:""+a._wrapperState.initialValue})}function Pe(a,b){var c=b.value;null==c&&(c=b.defaultValue,b=b.children,null!=b&&(null!=c?r("92"):void 0,Array.isArray(b)&&(1>=b.length?void 0:r("93"),b=b[0]),c=b),null==c&&(c=""));a._wrapperState={initialValue:Pc(c)};}
...
function nf(a){for(a=a.firstChild;a&&1!==a.nodeType&&3!==a.nodeType;)a=a.nextSibling;return a}var of=[],pf=-1;function I(a){0>pf||(a.current=of[pf],of[pf]=null,pf--);}function J(a,b){pf++;of[pf]=a.current;a.current=b;}var qf={},K={current:qf},L={current:!1},rf=qf;
...
function Yf(a,b,c,d,e,f){switch(c.tag){case 1:return a=c.payload,"function"===typeof a?a.call(f,d,e):a;case 3:a.effectTag=a.effectTag&-1025|64;case 0:a=c.payload;e="function"===typeof a?a.call(f,d,e):a;if(null===e||void 0===e)break;return objectAssign({},d,e);case 2:Qf=!0;}return d}
...
function ch(a,b){if(a&&a.defaultProps){b=objectAssign({},b);a=a.defaultProps;for(var c in a)void 0===b[c]&&(b[c]=a[c]);}return b}
...
Ch=function(a,b,c,d,e){var f=a.memoizedProps;if(f!==d){var g=b.stateNode;ng(O.current);a=null;switch(c){case "input":f=Qc(g,f);d=Qc(g,d);a=[];break;case "option":f=Me(g,f);d=Me(g,d);a=[];break;case "select":f=objectAssign({},f,{value:void 0});d=objectAssign({},d,{value:void 0});a=[];break;case "textarea":f=Oe(g,f);d=Oe(g,d);a=[];break;default:"function"!==typeof f.onClick&&"function"===typeof d.onClick&&(g.onclick=ef);}bf(c,d);g=c=void 0;var h=null;for(c in f)if(!d.hasOwnProperty(c)&&f.hasOwnProperty(c)&&null!=f[c])if("style"===
...
p);g=m;break;case "video":case "audio":for(g=0;g<lb.length;g++)H(lb[g],p);g=m;break;case "source":H("error",p);g=m;break;case "img":case "image":case "link":H("error",p);H("load",p);g=m;break;case "form":H("reset",p);H("submit",p);g=m;break;case "details":H("toggle",p);g=m;break;case "input":Rc(p,m);g=Qc(p,m);H("invalid",p);df(v,"onChange");break;case "option":g=Me(p,m);break;case "select":p._wrapperState={wasMultiple:!!m.multiple};g=objectAssign({},m,{value:void 0});H("invalid",p);df(v,"onChange");break;case "textarea":Pe(p,
...
e?null:e}function xg(a,b){a=hi(a,b);null!==a&&(!Vh&&0!==S&&b<S&&Zh(),Mf(a,b),Vh&&!Yh&&R===a||ii(a,a.expirationTime),ji>ki&&(ji=0,r("185")));}function li(a,b,c,d,e){var f=Uh;Uh=1;try{return a(b,c,d,e)}finally{Uh=f;}}var U=null,V=null,mi=0,ni=void 0,W=!1,X=null,Y=0,gi=0,oi=!1,pi=!1,qi=null,ri=null,Z=!1,si=!1,fi=!1,ti=null,ui=scheduler.unstable_now(),vi=(ui/10|0)+2,wi=vi,ki=50,ji=0,xi=null,yi=1;function zi(){vi=((scheduler.unstable_now()-ui)/10|0)+2;}
function Ai(a,b){if(0!==mi){if(b>mi)return;null!==ni&&scheduler.unstable_cancelCallback(ni);}mi=b;a=scheduler.unstable_now()-ui;ni=scheduler.unstable_scheduleCallback(Bi,{timeout:10*(b-2)-a});}function ei(a,b,c,d,e){a.expirationTime=d;0!==e||ci()?0<e&&(a.timeoutHandle=kf(Ci.bind(null,a,b,c),e)):(a.pendingCommitExpirationTime=c,a.finishedWork=b);}function Ci(a,b,c){a.pendingCommitExpirationTime=c;a.finishedWork=b;zi();wi=vi;Di(a,c);}function vg(){if(W)return wi;Ei();if(0===Y||1073741823===Y)zi(),wi=vi;return wi}
...
Pa,Qa,Ga.injectEventPluginsByName,sa,Wa,function(a){Ba(a,Va);},Wb,Xb,ee,Ia]},unstable_createRoot:function(a,b){Ui(a)?void 0:r("278");return new Ti(a,!0,null!=b&&!0===b.hydrate)}};(function(a){var b=a.findFiberByHostInstance;return Cf(objectAssign({},a,{findHostInstanceByFiber:function(a){a=Jd(a);return null===a?null:a.stateNode},findFiberByHostInstance:function(a){return b?b(a):null}}))})({findFiberByHostInstance:Na,bundleType:0,version:"16.6.0",rendererPackageName:"react-dom"});
...
function constructWithOptions(componentConstructor, tag) {
  ...
  templateFunction.attrs = function (attrs) {
    return constructWithOptions(componentConstructor, tag, _extends$2({}, options, {
      attrs: _extends$2({}, options.attrs || EMPTY_OBJECT, attrs)
    }));
  };
...
var isHMREnabled = "production" !== 'production';
...
var TYPE_STATICS$1 = (_TYPE_STATICS = {}, _TYPE_STATICS[reactIs.ForwardRef] = {
  $$typeof: true,
  render: true
}, _TYPE_STATICS);
...
var StyledComponent = function (_Component) {
  ...
  StyledComponent.prototype.renderInner = function renderInner(theme) {
    ...
    for (key in computedProps) {
      ...
      if (key === 'forwardedClass' || key === 'as') continue;else if (key === 'forwardedRef') propsForElement.ref = computedProps[key];else if (!isTargetTag || index$2(key)) {
...
function createStyledComponent(target, options, rules) {
  ...
  var finalAttrs =
  // $FlowFixMe
  isTargetStyledComp && target.attrs ? _extends$2({}, target.attrs, attrs) : attrs;
  ...
  var WrappedStyledComponent = React__default.forwardRef(function (props, ref) {
    return React__default.createElement(ParentComponent, _extends$2({}, props, { forwardedClass: WrappedStyledComponent, forwardedRef: ref }));
  });
...
var Action = function (_Component) {
	...
	function Action() {
		...
		return _ret = (_temp = (_this = possibleConstructorReturn$1(this, (_ref = Action.__proto__ || Object.getPrototypeOf(Action)).call.apply(_ref, [this].concat(args))), _this), _this.getIcon = function (id) {
			switch (id) {
				case 'update':
					return 'edit';
				case 'delete':
	...
	createClass$1(Action, [{
		...
		value: function render() {
			...
			return React__default.createElement(
				...
				React__default.createElement(
					'a',
					{ title: data.name, href: data.url, target: '_blank', className: 'crud-action', onClick: this.handleClick },
					React__default.createElement(antd.Icon, { type: this.getIcon(data.id) || data.icon })
				)
			);
		}
	}]);
...
var BooleanCell = function BooleanCell(value) {
	return React__default.createElement(
		'span',
		null,
		value ? React__default.createElement(antd.Icon, { type: 'check', style: { color: 'green' } }) : React__default.createElement(antd.Icon, { type: 'close', style: { color: 'red' } })
	);
};
	...
	if (obj.length) {
		obj.map(function (arr) {
			return arr.map(function (_ref) {
				...
				var restAttributes = rest ? rest.map(function (el) {
					return React__default.createElement(
						'span',
						null,
						el
				...
				return React__default.createElement(
					...
					React__default.createElement(
						'p',
						null,
						created_at ? hooks(created_at).format('DD.MM.YYYY') : '',
						' ',
						updated_at ? hooks(updated_at).format('DD.MM.YYYY') : '',
						' ',
						restAttributes
					)
				);
...
var createMemoryHistory = function createMemoryHistory() {
  ...
  var push = function push(path, state) {
    warning_1$1(!((typeof path === 'undefined' ? 'undefined' : _typeof$4(path)) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to push when the 1st ' + 'argument is a location-like object that already has state; it is ignored');
  ...
  var replace = function replace(path, state) {
    warning_1$1(!((typeof path === 'undefined' ? 'undefined' : _typeof$4(path)) === 'object' && path.state !== undefined && state !== undefined), 'You should avoid providing a 2nd state argument to replace when the 1st ' + 'argument is a location-like object that already has state; it is ignored');
...
var __DEV__$2 = "production" !== 'production';
...
var Link = function (_React$Component) {
  ...
  Link.prototype.render = function render() {
    ...
    return React__default.createElement("a", _extends$9({}, props, { onClick: this.handleClick, href: href, ref: innerRef }));
  };
...
var NavLink = function NavLink(_ref) {
  ...
  return React__default.createElement(Route, {
    ...
    children: function children(_ref2) {
      ...
      return React__default.createElement(Link, _extends$11({
        to: to,
...
var StaticRouter = function (_React$Component) {
  ...
  StaticRouter.prototype.render = function render() {
    ...
    return React__default.createElement(Router, _extends$13({}, props, { history: history }));
  };
...
var CrudView = function (_Component) {
	inherits$1(CrudView, _Component);
	...
	function CrudView() {
		...
		classCallCheck$1(this, CrudView);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = possibleConstructorReturn$1(this, (_ref = CrudView.__proto__ || Object.getPrototypeOf(CrudView)).call.apply(_ref, [this].concat(args))), _this), _this.handleTableChange = function (pagination, filters, sorter) {
...
var initialize = function initialize(form, values, keepDirty) {
  ...
  return {
    type: INITIALIZE,
    meta: _extends$15({ form: form, keepDirty: keepDirty }, otherMeta),
    payload: values
  };
};
...
var FormSection = function (_Component) {
  ...
  function FormSection(props, context) {
    _classCallCheck$11(this, FormSection);
  ...
  _createClass$1(FormSection, [{
    ...
    value: function getChildContext() {
      ...
      return {
        _reduxForm: _extends$16({}, context._reduxForm, {
    ...
    value: function render() {
      var _props = this.props,
          ...
          name = _props.name,
          component = _props.component,
          rest = _objectWithoutProperties$4(_props, ['children', 'name', 'component']);

      if (React__default.isValidElement(children)) {
        return children;
      }

      return React.createElement(component, _extends$16({}, rest, {
        children: children
      }));
    }
  }]);
...
var SubmissionError = function (_ExtendableError) {
  _inherits$13(SubmissionError, _ExtendableError);

  function SubmissionError(errors) {
    _classCallCheck$13(this, SubmissionError);

    var _this = _possibleConstructorReturn$13(this, (SubmissionError.__proto__ || Object.getPrototypeOf(SubmissionError)).call(this, 'Submit Validation Failed'));
...
var createFieldProps = function createFieldProps(_ref2, name, _ref) {
  ...
  var asyncError = _ref.asyncError,
      ...
      _value = _ref._value,
      warn = _ref.warn,
      custom = _objectWithoutProperties$5(_ref, ['asyncError', 'asyncValidating', 'onBlur', 'onChange', 'onDrop', 'onDragStart', 'dirty', 'dispatch', 'onFocus', 'form', 'format', 'initial', 'parse', 'pristine', 'props', 'state', 'submitError', 'submitFailed', 'submitting', 'syncError', 'syncWarning', 'validate', 'value', '_value', 'warn']);
  ...
  return {
    ...
    custom: _extends$17({}, custom, props)
  };
};
...
var setInWithPath = function setInWithPath(state, value, path, pathIndex) {
  ...
  return _extends$18({}, state, _defineProperty({}, first, next));
};
...
function deleteInWithPath(state, first) {
  ...
  if (rest.length) {
    ...
    if (first in state) {
      ...
      return state[first] === _result ? state : _extends$19({}, state, _defineProperty$1({}, first, _result));
    }
    return state;
  }
  if (Array.isArray(state)) {
...
var isObject$2 = function isObject(entity) {
  return entity && (typeof entity === 'undefined' ? 'undefined' : _typeof$6(entity)) === 'object';
};

var isFunction$3 = function isFunction(entity) {
  return entity && typeof entity === 'function';
};

var eventPreventDefault = function eventPreventDefault(event) {
  if (isObject$2(event) && isFunction$3(event.preventDefault)) {
    event.preventDefault();
  }
};

var eventDataTransferGetData = function eventDataTransferGetData(event, key) {
  if (isObject$2(event) && isObject$2(event.dataTransfer) && isFunction$3(event.dataTransfer.getData)) {
    return event.dataTransfer.getData(key);
  }
};

var eventDataTransferSetData = function eventDataTransferSetData(event, key, value) {
  if (isObject$2(event) && isObject$2(event.dataTransfer) && isFunction$3(event.dataTransfer.setData)) {
...
var createConnectedField = function createConnectedField(structure$$1) {
  ...
  var ConnectedField = function (_Component) {
    _inherits$14(ConnectedField, _Component);
    ...
    function ConnectedField() {
      ...
      _classCallCheck$14(this, ConnectedField);

      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      return _ret = (_temp = (_this = _possibleConstructorReturn$14(this, (_ref = ConnectedField.__proto__ || Object.getPrototypeOf(ConnectedField)).call.apply(_ref, [this].concat(args))), _this), _this.saveRef = function (ref) {
    ...
    _createClass$2(ConnectedField, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            rest = _objectWithoutProperties$6(_props, ['component', 'withRef', 'name', '_reduxForm', 'normalize', 'onBlur', 'onChange', 'onFocus', 'onDragStart', 'onDrop', 'immutableProps']);

        var _createFieldProps = createFieldProps(structure$$1, name, _extends$20({}, rest, {
          ...
          onFocus: this.handleFocus
            ...
            props = _objectWithoutProperties$6(_createFieldProps, ['custom']);
 ...
 // eslint-disable-line no-unused-vars
          ...
          return React.createElement(component, _extends$20({}, input, custom));
        } else {
          return React.createElement(component, _extends$20({}, props, custom));
        }
      }
    }]);
...
var createField = function createField(structure$$1) {
  ...
  var Field = function (_Component) {
    _inherits$15(Field, _Component);

    function Field(props, context) {
      _classCallCheck$15(this, Field);

      var _this = _possibleConstructorReturn$15(this, (Field.__proto__ || Object.getPrototypeOf(Field)).call(this, props, context));
    ...
    _createClass$3(Field, [{
      ...
      key: 'render',
      value: function render() {
        return React.createElement(ConnectedField, _extends$21({}, this.props, {
          name: this.name,
...
var createConnectedFields = function createConnectedFields(structure$$1) {
  ...
  var ConnectedFields = function (_React$Component) {
    _inherits$16(ConnectedFields, _React$Component);

    function ConnectedFields(props) {
      _classCallCheck$16(this, ConnectedFields);

      var _this = _possibleConstructorReturn$16(this, (ConnectedFields.__proto__ || Object.getPrototypeOf(ConnectedFields)).call(this, props));
    ...
    _createClass$4(ConnectedFields, [{
      ...
      value: function render() {
        ...
        var _props = this.props,
            ...
            _reduxForm = _props._reduxForm,
            rest = _objectWithoutProperties$7(_props, ['component', 'withRef', '_fields', '_reduxForm']);
        ...
        var _Object$keys$reduce = Object.keys(_fields).reduce(function (accumulator, name) {
          ...
          var _createFieldProps = createFieldProps(structure$$1, name, _extends$22({}, connectedProps, rest, {
            ...
            onFocus: _this4.onFocusFns[name]
              ...
              custom = _createFieldProps.custom,
              fieldProps = _objectWithoutProperties$7(_createFieldProps, ['custom']);
          ...
          return structure.setIn(accumulator, fieldName, fieldProps);
            ...
            props = _objectWithoutProperties$7(_Object$keys$reduce, ['custom']);
...
var createFields = function createFields(structure$$1) {
  ...
  var Fields = function (_Component) {
    _inherits$17(Fields, _Component);

    function Fields(props, context) {
      _classCallCheck$17(this, Fields);

      var _this = _possibleConstructorReturn$17(this, (Fields.__proto__ || Object.getPrototypeOf(Fields)).call(this, props, context));
    ...
    _createClass$5(Fields, [{
      ...
      value: function render() {
        ...
        return React.createElement(ConnectedFields, _extends$23({}, this.props, {
...
var createFieldArrayProps = function createFieldArrayProps(_ref2, name, form, sectionPrefix, getValue, _ref) {
  ...
  var arrayInsert = _ref.arrayInsert,
      ...
      value = _ref.value,
      props = _ref.props,
      rest = _objectWithoutProperties$8(_ref, ['arrayInsert', 'arrayMove', 'arrayPop', 'arrayPush', 'arrayRemove', 'arrayRemoveAll', 'arrayShift', 'arraySplice', 'arraySwap', 'arrayUnshift', 'asyncError', 'dirty', 'length', 'pristine', 'submitError', 'state', 'submitFailed', 'submitting', 'syncError', 'syncWarning', 'value', 'props']);
...
var createConnectedFieldArray = function createConnectedFieldArray(structure$$1) {
  ...
  var ConnectedFieldArray = function (_React$Component) {
    _inherits$18(ConnectedFieldArray, _React$Component);
    ...
    function ConnectedFieldArray() {
      ...
      _classCallCheck$18(this, ConnectedFieldArray);

      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      return _ret = (_temp = (_this = _possibleConstructorReturn$18(this, (_ref = ConnectedFieldArray.__proto__ || Object.getPrototypeOf(ConnectedFieldArray)).call.apply(_ref, [this].concat(args))), _this), _this.saveRef = function (ref) {
        _this.ref = ref;
      }, _this.getValue = function (index) {
        return _this.props.value && getIn(_this.props.value, String(index));
      }, _temp), _possibleConstructorReturn$18(_this, _ret);
    }
    ...
    _createClass$6(ConnectedFieldArray, [{
      ...
      value: function render() {
        var _props = this.props,
            ...
            rest = _objectWithoutProperties$9(_props, ['component', 'withRef', 'name', '_reduxForm', 'validate', 'warn', 'rerenderOnEveryChange']);
...
var createFieldArray = function createFieldArray(structure) {
  ...
  var FieldArray = function (_Component) {
    _inherits$19(FieldArray, _Component);

    function FieldArray(props, context) {
      _classCallCheck$19(this, FieldArray);

      var _this = _possibleConstructorReturn$19(this, (FieldArray.__proto__ || Object.getPrototypeOf(FieldArray)).call(this, props, context));
    ...
    _createClass$7(FieldArray, [{
      ...
      key: 'render',
      value: function render() {
        return React.createElement(ConnectedFieldArray, _extends$25({}, this.props, {
          name: this.name,
          _reduxForm: this.context._reduxForm,
          ref: this.saveRef
        }));
  ...
  return function (firstArg) {
    ...
    return function (Component) {
      var FormValues = function (_React$Component) {
        _inherits$20(FormValues, _React$Component);

        function FormValues(props, context) {
          _classCallCheck$20(this, FormValues);

          var _this = _possibleConstructorReturn$20(this, (FormValues.__proto__ || Object.getPrototypeOf(FormValues)).call(this, props, context));
        ...
        _createClass$8(FormValues, [{
          ...
          value: function render() {
            ...
            , _extends$26({ sectionPrefix: this.context._reduxForm.sectionPrefix
            }, this.props));
          }
        }, {
          key: 'updateComponent',
          ...
          value: function setComponent() {
            ...
            this.Component = connect(formValuesSelector, function () {
              ...
              var sectionPrefix = _ref3.sectionPrefix,
                  otherProps = _objectWithoutProperties$10(_ref3, ['sectionPrefix']);
...
var getError = function getError(value, values, props, validators, name) {
  var array = toArray$3(validators);
...
var handleSubmit = function handleSubmit(submit, props, valid, asyncValidate, fields) {
  ...
  if (valid || persistentSubmitErrors) {
    ...
    setSubmitFailed.apply(undefined, _toConsumableArray$3(fields));
    var errors = _extends$27({}, asyncErrors, syncErrors);
    if (onSubmitFail) {
...
var isClassComponent = function isClassComponent(Component) {
  return Boolean(Component && Component.prototype && _typeof$7(Component.prototype.isReactComponent) === 'object');
};
...
var arrayInsert$1 = actions$3.arrayInsert,
    ...
    arrayPop$1 = actions$3.arrayPop,
    arrayPush$2 = actions$3.arrayPush,
    arrayRemove$1 = actions$3.arrayRemove,
    arrayRemoveAll$1 = actions$3.arrayRemoveAll,
    arrayShift$1 = actions$3.arrayShift,
    arraySplice$1 = actions$3.arraySplice,
    arraySwap$1 = actions$3.arraySwap,
    arrayUnshift$1 = actions$3.arrayUnshift,
    blur$1 = actions$3.blur,
    change$1 = actions$3.change,
    focus$1 = actions$3.focus,
    formActions = _objectWithoutProperties$11(actions$3, ['arrayInsert', 'arrayMove', 'arrayPop', 'arrayPush', 'arrayRemove', 'arrayRemoveAll', 'arrayShift', 'arraySplice', 'arraySwap', 'arrayUnshift', 'blur', 'change', 'focus']);
      ...
      var Form = function (_Component) {
            ...
            if (!submitOrEvent || silenceEvent(submitOrEvent)) {
              ...
              if (!_this.submitPromise) {
                ...
                if (_this.innerOnSubmit && _this.innerOnSubmit !== _this.submit) {
                  ...
                  return _this.listenToSubmit(handleSubmit(checkSubmit(onSubmit), _extends$28({}, _this.props, bindActionCreators({ blur: blur, change: change }, dispatch)), _this.props.validExceptSubmit, _this.asyncValidate, _this.getFieldList({ excludeFieldArray: true })));
                }
              }
            } else {
              // submitOrEvent is the submit function: return deferred submit thunk
              return silenceEvents(function () {
                return !_this.submitPromise && _this.listenToSubmit(handleSubmit(checkSubmit(submitOrEvent), _extends$28({}, _this.props, bindActionCreators({ blur: blur, change: change }, dispatch)), _this.props.validExceptSubmit, _this.asyncValidate, _this.getFieldList({ excludeFieldArray: true })));
              });
            }
        ...
        _createClass$9(Form, [{
          ...
          value: function getChildContext() {
            ...
            return {
              _reduxForm: _extends$28({}, this.props, {
                getFormState: function getFormState(state) {
            ...
            if (validate || fieldLevelValidate) {
              ...
              if (shouldError(validateParams)) {
                ...
                var _merge2 = merge(validate ? validate(propsToValidate.values, propsToValidate) || {} : {}, fieldLevelValidate ? fieldLevelValidate(propsToValidate.values, propsToValidate) || {} : {}),
                    ...
                    nextSyncErrors = _objectWithoutProperties$11(_merge2, ['_error']);
            ...
            if (warn || fieldLevelWarn) {
              ...
              if (shouldWarn(validateParams)) {
                ...
                var _merge3 = merge(warn ? warn(propsToWarn.values, propsToWarn) : {}, fieldLevelWarn ? fieldLevelWarn(propsToWarn.values, propsToWarn) : {}),
                    ...
                    nextSyncWarnings = _objectWithoutProperties$11(_merge3, ['_warning']);
          ...
          value: function render() {
            ...
            var _props9 = this.props,
                ...
                rest = _objectWithoutProperties$11(_props9, ['anyTouched', 'array', 'arrayInsert', 'arrayMove', 'arrayPop', 'arrayPush', 'arrayRemove', 'arrayRemoveAll', 'arrayShift', 'arraySplice', 'arraySwap', 'arrayUnshift', 'asyncErrors', 'asyncValidate', 'asyncValidating', 'blur', 'change', 'clearSubmit', 'destroy', 'destroyOnUnmount', 'forceUnregisterOnUnmount', 'dirty', 'dispatch', 'enableReinitialize', 'error', 'focus', 'form', 'getFormState', 'immutableProps', 'initialize', 'initialized', 'initialValues', 'invalid', 'keepDirtyOnReinitialize', 'keepValues', 'updateUnregisteredFields', 'pristine', 'propNamespace', 'registeredFields', 'registerField', 'reset', 'resetSection', 'setSubmitFailed', 'setSubmitSucceeded', 'shouldAsyncValidate', 'shouldValidate', 'shouldError', 'shouldWarn', 'startAsyncValidation', 'startSubmit', 'stopAsyncValidation', 'stopSubmit', 'submitting', 'submitFailed', 'submitSucceeded', 'touch', 'touchOnBlur', 'touchOnChange', 'persistentSubmitErrors', 'syncErrors', 'syncWarnings', 'unregisterField', 'untouch', 'updateSyncErrors', 'updateSyncWarnings', 'valid', 'validExceptSubmit', 'values', 'warning']);
            /* eslint-enable no-unused-vars */


            var reduxFormProps = _extends$28({
              array: array,
            ...
            var propsToPass = _extends$28({}, propNamespace ? _defineProperty$4({}, propNamespace, reduxFormProps) : reduxFormProps, rest);
...
propsToPass.ref = this.saveRef;
      ...
      var connector = connect(function (state, props) {
        ...
        var computedActions = _extends$28({}, connectedFormACs, boundArrayACs, {
          blur: boundBlur,
          change: boundChange,
      ...
      var ConnectedForm = hoistNonReactStatics_cjs$1(connector(Form), WrappedComponent);
      ConnectedForm.defaultProps = config;

      // build outer component to expose instance api

      var ReduxForm = function (_Component2) {
        _inherits$21(ReduxForm, _Component2);

        function ReduxForm() {
          _classCallCheck$21(this, ReduxForm);

          return _possibleConstructorReturn$21(this, (ReduxForm.__proto__ || Object.getPrototypeOf(ReduxForm)).apply(this, arguments));
        }
        ...
        _createClass$9(ReduxForm, [{
          ...
          value: function render() {
            ...
            var _props10 = this.props,
                ...
                rest = _objectWithoutProperties$11(_props10, ['initialValues']);

            return React.createElement(ConnectedForm, _extends$28({}, rest, {
      ...
      polyfill(ReduxForm);
      return hoistNonReactStatics_cjs$1(ReduxForm, WrappedComponent);
    };
  };
};
  ...
  var behaviors = (_behaviors = {}, _defineProperty$5(_behaviors, ARRAY_INSERT, function (state, _ref2) {
    ...
    if (payload && Object.keys(payload).length) {
      var _error = payload._error,
          fieldErrors = _objectWithoutProperties$12(payload, ['_error']);
...
var createValues$1 = function createValues(_ref) {
  ...
  return function (config) {
    var _prop$getFormState$co = _extends$29({
      prop: 'values',
      getFormState: function getFormState(state) {
        return getIn(state, 'form');
      }
...
var stopSubmit$1 = actions$3.stopSubmit;
...
var ru_RU = createCommonjsModule(function (module, exports) {
...
var ru_RU$2 = createCommonjsModule(function (module, exports) {
...
unwrapExports(ru_RU$2);

var ru_RU$4 = createCommonjsModule(function (module, exports) {
...
var _ru_RU = _interopRequireDefault(ru_RU);

var _ru_RU2 = _interopRequireDefault(ru_RU$2);
...
var locale$1 = unwrapExports(ru_RU$4);
	...
	return React__default.createElement(
		...
		function () {
			switch (type) {
				...
				case 'textarea':
					return React__default.createElement(antd.Input.TextArea, _extends$3({}, input, {
						placeholder: placeholder,
						type: type,
				...
				case 'search':
					return React__default.createElement(Search, _extends$3({
				...
				case 'date':
					console.log(input);
					return React__default.createElement(antd.DatePicker, _extends$3({
						style: { width: '100%' },
						onPressEnter: onPressEnter
					}, input, {
				...
				default:
					return React__default.createElement(antd.Input, _extends$3({
						onPressEnter: onPressEnter
					}, input, {
						value: input.value || defaultValue,
						placeholder: placeholder,
...
var CreateModalForm = function (_Component) {
	inherits$1(CreateModalForm, _Component);
	...
	function CreateModalForm() {
		...
		classCallCheck$1(this, CreateModalForm);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = possibleConstructorReturn$1(this, (_ref = CreateModalForm.__proto__ || Object.getPrototypeOf(CreateModalForm)).call.apply(_ref, [this].concat(args))), _this), _this.handleCancel = function () {
			_this.props.onClose();
			...
			return fields.map(function (props) {
				...
				) : React__default.createElement(Field, _extends$3({}, props, {
...
var CrudFull = function (_Component) {
	...
	function CrudFull() {
		...
		classCallCheck$1(this, CrudFull);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = possibleConstructorReturn$1(this, (_ref = CrudFull.__proto__ || Object.getPrototypeOf(CrudFull)).call.apply(_ref, [this].concat(args))), _this), _this.actionsFunc = function (action, elem) {
			...
			return React__default.createElement(
				...
				!createDisabled ? React__default.createElement(
					Btn,
					{
						...
						style: _extends$3({}, btnStyle, { marginBottom: '20px' })
					},
					createButtonTitle
				) : null,
...
var crudModelsReducer = function crudModelsReducer() {
	...
	switch (type) {
		case actions.FETCH_CRUD_MODELS + SUCCESS$1:
			return _extends$3({}, state, defineProperty$2({}, payload.params.modelName, response));
		case actions.FETCH_CRUD_MODELS + ERROR:
			return _extends$3({}, state, defineProperty$2({}, payload.params.modelName, _extends$3({}, state[payload.params.modelName], {
				loading: false,
				error: error
			})));
		...
		case actions.FETCH_CRUD_CHILDREN + SUCCESS$1:
			...
			return _extends$3({}, state, defineProperty$2({}, payload.params.modelName, _extends$3({}, model, {
				data: _extends$3({}, model.data, {
					items: model.data.items.map(function (elem) {
						return elem.id === payload.id ? _extends$3({}, elem, {
...
var crudFilterValuesReducer = function crudFilterValuesReducer() {
	...
	switch (type) {
		case actions.FETCH_CRUD_FILTER_VALUES + SUCCESS$1:
			return _extends$3({}, state, defineProperty$2({
				loading: false
			}, payload.modelName, _extends$3({}, state[payload.modelName], defineProperty$2({}, payload.filter, response.data))));
		case actions.FETCH_CRUD_FILTER_VALUES + ERROR:
			return _extends$3({}, state, { loading: false, error: error
			});
		case actions.FETCH_CRUD_FILTER_VALUES + START:
			return _extends$3({}, state, { loading: true });
		default:
			return state;
	}
};
...
var crudActionsFuncReducer = function crudActionsFuncReducer() {
	...
	switch (type) {
		case actions.SET_CRUD_ACTIONS_FUNC:
			return _extends$3({}, state, defineProperty$2({}, payload.modelName, payload.func));
		default:
			return state;
	}
};
...
var crudParamsReducer = function crudParamsReducer() {
	...
	switch (type) {
		case actions.SET_CRUD_PARAMS:
			return _extends$3({}, state, defineProperty$2({}, payload.modelName, payload));
		default:
			return state;
	}
};
...
function deprecate$1(fn, deprecationWarning) {
  return function () {
...
put.sync = /*#__PURE__*/deprecate$1(put.resolve, /*#__PURE__*/updateIncentive('put.sync', 'put.resolve'));
...
var _marked = /*#__PURE__*/runtimeModule.mark(fetchCrudModelsSaga),
    _marked2 = /*#__PURE__*/runtimeModule.mark(fetchCrudModelsSuccessSaga),
    _marked3 = /*#__PURE__*/runtimeModule.mark(fetchCrudFilterValuesSaga),
    _marked4 = /*#__PURE__*/runtimeModule.mark(createModelSaga),
    _marked5 = /*#__PURE__*/runtimeModule.mark(updateModelsSaga),
...
function getFiltersValues(filters, columns) {
	...
	var res = Object.keys(filters).reduce(function (acc, key) {
		return _extends$3({}, acc, defineProperty$2({}, key, isDateColumn(columns, key) ? hooks(filters[key]).unix() : filters[key].constructor !== Array ? filters[key] : null));
	}, {});
		...
		while (1) {
			switch (_context.prev = _context.next) {
				...
				case 12:
					...
					params = payload ? dist_6(_extends$3({}, filters, {
					...
					_context.next = 19;
					return put(dist_1$1(_extends$3({}, action, {
						method: 'GET',
						auth: true,
						url: '' + url + paramsStr
					})));
...
function createModelSaga(action) {
	var params, modelName, form;
	return runtimeModule.wrap(function createModelSaga$(_context4) {
		while (1) {
...
function deleteModelSaga(action) {
	return runtimeModule.wrap(function deleteModelSaga$(_context6) {
		while (1) {
...
function restoreModelSaga(action) {
	return runtimeModule.wrap(function restoreModelSaga$(_context7) {
		while (1) {
...
function changeModelSaga(action) {
	...
	return runtimeModule.wrap(function changeModelSaga$(_context8) {
		while (1) {
